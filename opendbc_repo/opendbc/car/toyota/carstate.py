...
from opendbc.car.toyota.carstate_ext import CarStateExt
...
class CarState(CarStateBase, CarStateExt):
  ...
  def update(self, can_parsers) -> structs.CarState:
    ...
    if self.CP.carFingerprint not in RADAR_ACC_CAR or (self.CP_SP.flags & ToyotaFlags.SMART_DSU and not self.CP_SP.flags & ToyotaFlags.RADAR_CAN_FILTER):
